...
def motion_values(sample: MotionSample) -> tuple[int, int, int, int, int, int, int]:
...
class Controller:
    ...
    def __post_init__(self):
        ...
        self.focus = False
        self.bridge = OnshapeBridge(self.wamp_state_handler, self.controller_uri)
